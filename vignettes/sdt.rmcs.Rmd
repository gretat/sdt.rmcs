...
To run the analysis for one group there are a few options that can be used. Either simulate data with **sdt.data**, by giving it desired parameters (optional); 
run the analysis using **rate.statistics** without any input or use your own data set. 
